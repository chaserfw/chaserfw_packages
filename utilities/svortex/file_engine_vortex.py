...
import numpy as np
##################################################################################
class FileEngineVortex(FileVortex):
	def __init__(self, file_engine, input_format_config, otput_format_config, dtype=np.float):
		"""
		docstring
		"""
		super.__init__(file_engine, input_format_config, otput_format_config, dtype)
